package OrthoMCLWorkflow::Main::WorkflowSteps::InsertCoreTaxonNameVersion;
...
sub run {
    ...
    $self->runPlugin($test, $undo, "OrthoMCLData::Load::Plugin::InsertSingleCoreTaxonNameVersion", $args);
